...
export const Card: FC<IProps> = ({ className, title }) => {
    ...
    return <div className={`flex flex-col items-center gap-12 pt-10 ${ className ? className : '' }`}>
        ...
        <div className="h-[500px] w-[320px] rounded-lg bg-light-green flex flex-col justify-between">
            <div className="relative w-full h-52">
                <Image src="/images/bicycle.png" layout="fill" objectFit='cover' alt={'Bicycle image'} className="rounded-tl-lg rounded-tr-lg" />
            </div>
            <MetricVisualisation ico={<IcoTemperature />} className={'px-5 mt-6'} fromValue={'10'} toValue={'15'} unit={'°C'} />
